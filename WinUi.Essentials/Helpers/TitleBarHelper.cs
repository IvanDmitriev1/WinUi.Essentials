...
namespace WinUi.Essentials.Helpers;
...
public static class TitleBarHelper
{
    ...
    {
        if (!ApplicationEx.MainWindow.ExtendsContentIntoTitleBar)
            return;
        ...
        var hwnd = WinRT.Interop.WindowNative.GetWindowHandle(ApplicationEx.MainWindow);
